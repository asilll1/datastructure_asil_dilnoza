...
function QueueVisualizer() {
    ...
    const [queue, setQueue] = useState(new Queue(10));
    ...
    const handleCapacityChange = (newCapacity) => {
        ...
        setQueue(new Queue(newCapacity));
        setSteps([]);
        setCurrentStep(0);
        setError("");
    };
    ...
    return (
        <div className="visualizer-fullscreen">
            <div className="visualizer-title">Queue Visualizer</div>
            ...
            <div className="visualizer-controls">
                <div className="input-group">
                    ...
                    <input
                        ...
                        max="15"
                        value={capacity}
                        onChange={(e) => handleCapacityChange(Math.max(2, Math.min(15, parseInt(e.target.value) || 2)))}
