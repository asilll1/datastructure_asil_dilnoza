...
function CircularLinkedListVisualizer() {
    ...
    return (
        <div className="visualizer-fullscreen">
            <div className="visualizer-title">Circular Linked List Visualizer</div>
            <div className="visualizer-desc">
                A circular linked list is a linear data structure where the last node
                points back to the first node, creating a circular connection.
            </div>
                    ...
                    {currentState.nodes.map((value, index) => (
                        <div key={index} className="node-container">
                            ...
                            {index < currentState.nodes.length - 1 ? (
                                ...
                                <div className="arrow circular">↻</div>
                            )}
                        </div>
                    ))}
                </div>
